...
//@Component
public class CamelCameraFtpRouteBuilder extends RouteBuilder {
    ...
    public void init() {
        ...
        logger.info("Camel Camera Ftp RouteBuilder inited\n" + " camera downloadLocation:" + downloadLocation);
    }
